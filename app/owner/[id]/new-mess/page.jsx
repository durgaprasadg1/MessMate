        ...
        <div className="max-w-2xl mx-auto bg-gray-700 rounded-xl sm:rounded-2xl text-white shadow-lg p-4 sm:p-5 md:p-6">
          ...
          <p className="text-center text-gray-600 text-xs sm:text-sm mt-3 italic bg-yellow-100 border border-yellow-300 px-3 sm:px-4 py-2 rounded-lg shadow-sm">
            ...
            <span className="font-semibold">
              ...
              be gone for verification after successfull verification it is
              added automatically.
            </span>
            .
          </p>
          <p className="text-center text-gray-600 text-xs sm:text-sm mt-3 italic bg-yellow-100 border border-yellow-300 px-3 sm:px-4 py-2 rounded-lg shadow-sm">
            ...
            <br />
            <span className="font-semibold">
              आपकी मेस पहले वेरिफिकेशन प्रक्रिया में जाएगी और सफल वेरिफिकेशन के
              बाद स्वतः ही सूची में जोड़ दी जाएगी।
            </span>
          </p>
          ...
          {message && (
            ...
            >
              {message.type === "success"
                ? "वेरिफिकेशन के बाद आपकी मेस जोड़ दिया जाएगा। आपको जल्द ही मेल भेजी जाएगी।"
                : "कुछ गड़बड़ हो गई है। कृपया बाद में दोबारा कोशिश करें !"}
            </div>
          )}
